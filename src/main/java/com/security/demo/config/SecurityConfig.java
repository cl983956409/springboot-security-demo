...
import com.security.demo.service.user.PersistentTokenServiceImpl;
import com.security.demo.service.user.UserServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    PasswordEncoder passwordEncoder() {
        ...
        return new BCryptPasswordEncoder();//使用加密
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .tokenValiditySeconds(60 * 60 * 24) // 一天的有效期
